...
module prima(input [19:0] dataIn, clk, R_I, get_out, rst, readIn, [2:0] cnt, output [19:0] dataOut, reg R_O, reg get_in);

reg [19:0] matrix [4:0];
reg [19:0] RES;
reg [0:4] selected;
reg [2:0] x, x1, x2, x3, station;
reg [2:0] y [4:0], y1 [4:0], y2 [4:0], y3 [4:0];
reg [4:0] minimum;
reg [4:0] tmp1 [4:0], tmp2 [4:0], tmp3 [4:0], smoller [4:0];
integer i, j;
